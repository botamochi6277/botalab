...
const args = yargs(hideBin(process.argv))
  .command("* <userName> <api_key>", "fetch prototype data from ProtoPedia")
  .positional("userName", {
    describe: "userName to extract. For example, stack-chan is ｽﾀｯｸﾁｬﾝ. ",
    type: "string",
    demandOption: true,
  })
  .positional("api_key", {
...
const fetchProjectData = async (
  ...
  const url = `https://protopedia.net/v2/api/prototype/list?userNm=${userName}`
